...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>内容列表页面</title>
		<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/all.css" type="text/css" />

	</head>
	<body style="background: #e1e9eb;">
		<form action="<%= request.getContextPath()%>/WeChat/search" id="mainForm" name="mainForm" method="post">
			<div class="right">
